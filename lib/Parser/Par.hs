...
{-# INLINE happyOut26 #-}
newtype HappyWrap27 = HappyWrap27 ((Parser.Abs.BNFC'Position, Parser.Abs.AddOp))
happyIn27 :: ((Parser.Abs.BNFC'Position, Parser.Abs.AddOp)) -> (HappyAbsSyn )
happyIn27 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap27 x)
{-# INLINE happyIn27 #-}
happyOut27 :: (HappyAbsSyn ) -> HappyWrap27
happyOut27 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut27 #-}
newtype HappyWrap28 = HappyWrap28 ((Parser.Abs.BNFC'Position, Parser.Abs.MulOp))
happyIn28 :: ((Parser.Abs.BNFC'Position, Parser.Abs.MulOp)) -> (HappyAbsSyn )
happyIn28 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap28 x)
{-# INLINE happyIn28 #-}
happyOut28 :: (HappyAbsSyn ) -> HappyWrap28
happyOut28 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut28 #-}
newtype HappyWrap29 = HappyWrap29 ((Parser.Abs.BNFC'Position, Parser.Abs.RelOp))
happyIn29 :: ((Parser.Abs.BNFC'Position, Parser.Abs.RelOp)) -> (HappyAbsSyn )
...
happyReduction_8 happy_x_2
	...
	case happyOut4 happy_x_2 of { (HappyWrap4 happy_var_2) -> 
	happyIn10
		 ((fst happy_var_1, Parser.Abs.Arg (fst happy_var_1) (snd happy_var_1) (snd happy_var_2))
	)}}
